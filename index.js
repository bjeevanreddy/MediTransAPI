...
mongoose.connect('mongodb+srv://jeevan:<password>@jeevan-9ruiz.mongodb.net/test?retryWrites=true&w=majority', { useNewUrlParser: true, useUnifiedTopology: true, useCreateIndex: true }, (error, res) => {
    if (res) {
